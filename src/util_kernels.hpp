...
namespace UtilKernels
{
     ...
     *
     */
    void swap_axes_cutranspose(const Complex *const d_in, Complex *const d_out, const unsigned int num_cols, const unsigned int num_rows, const unsigned int block_size, cudaStream_t s);
